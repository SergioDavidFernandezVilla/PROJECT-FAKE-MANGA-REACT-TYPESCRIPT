...
import PortadaDragonBall from "../../assets/images/portada_dragon_ball.webp"
...
export const DataManga: MangaType[] = [
    {
        id: 1,
        title: "Naruto",
        description: "Un manga que narra la historia de Naruto Uzumaki, un ninja joven que sueña con convertirse en Hokage y proteger a su aldea.",
        ...
        chapters: [
            ...
            },
            {
              ...
              description: "Naruto se enfrenta a las pruebas del examen para convertirse en un ninja.",
    ...
    },
    {
        id: 2,
        title: "One Punch Man",
        description: "La historia sigue a Saitama, un héroe que puede derrotar a cualquier enemigo de un solo golpe, pero lucha contra el aburrimiento y la falta de desafíos.",
        ...
        chapters: [
            ...
            },
            {
              ...
              description: "Saitama conoce a Genos, un joven cyborg que se convierte en su discípulo.",
    ...
    },
    {
        id: 3,
        title: "Bleach",
        description: "Ichigo Kurosaki obtiene poderes de shinigami y lucha para proteger a los vivos y a las almas en el más allá.",
        ...
        chapters: [
            {
              ...
              description: "Ichigo recibe sus poderes de shinigami después de salvar a una niña de un hollow.",
            ...
            },
            {
              ...
              description: "Ichigo comienza su entrenamiento para perfeccionar sus habilidades como shinigami.",
    ...
    },
    {
        ...
        description: "La humanidad vive detrás de murallas gigantes para protegerse de los titanes, mientras descubren secretos sobre su verdadera naturaleza.",
        ...
        chapters: [
            ...
            },
            {
              ...
              description: "Eren y sus amigos descubren los secretos detrás de los titanes.",
    ...
    },
    {
        id: 5,
        title: "Dragon Ball",
        description: "Goku, un guerrero Saiyajin, defiende la Tierra junto a sus amigos, enfrentando enemigos poderosos en busca de las Esferas del Dragón.",
        ...
        chapters: [
            {
              ...
              description: "Goku comienza su aventura para encontrar las Esferas del Dragón.",
            ...
            },
            {
              ...
              description: "Goku participa en el torneo de artes marciales para demostrar sus habilidades.",
    ...
    },
    {
        id: 6,
        title: "Demon Slayer",
        description: "Tanjiro Kamado lucha contra demonios para vengar a su familia y salvar a su hermana Nezuko, quien fue convertida en demonio.",
        ...
        chapters: [
            {
              ...
              description: "Tanjiro encuentra a su familia muerta y a su hermana convertida en demonio.",
            ...
            },
            {
              ...
              description: "Tanjiro decide convertirse en cazador de demonios para salvar a su hermana.",
    ...
    },
    {
        ...
        description: "Yuji Itadori se une a la escuela de hechicería Jujutsu para luchar contra maldiciones y proteger a las personas.",
        ...
        chapters: [
            {
              ...
              description: "Yuji descubre el mundo de las maldiciones después de comer un fragmento de una maldición poderosa.",
            ...
            },
            {
              ...
              description: "Yuji es entrenado en el arte de las maldiciones por Satoru Gojo.",
            ...
            },
            {
              ...
              description: "Yuji lucha contra una maldición poderosa para salvar a sus amigos.",
    ...
    },
    {
        ...
        description: "Izuku Midoriya sueña con ser un héroe en un mundo donde las personas tienen poderes llamados 'Quirks'.",
        ...
        chapters: [
            {
              ...
              description: "Izuku decide seguir el camino de héroe a pesar de no tener un Quirk.",
            ...
            },
            {
              ...
              description: "Izuku comienza sus estudios en la U.A. y enfrenta su primera prueba.",
